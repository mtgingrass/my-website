...
I started building this [Habit Tracker](https://github.com/mtgingrass/SimpleHabit "Github Repo")app as my first real-world iOS application designed specifically for the iPhone using SwiftUI and Xcode. I wanted to build something I actually believe in to keep me interested. Something useful, simple, and scalable.
