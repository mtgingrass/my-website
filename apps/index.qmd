...
I set out to prove I could take native iOS apps from idea to the App Store, and shipped them. SwiftUI apps solving real problems with clean, intuitive design and privacy-first principles. See [Projects](/projects/) for the full picture, including my serverless AWS work.

[View Source Code](https://github.com/mtgingrass){.btn .btn-primary} [Contact Me](mailto:mark@markgingrass.com){.btn .btn-secondary}
:::
:::
...
[Download on App Store](https://apps.apple.com/us/app/greenvillerunclubs/id6749022264){.btn .btn-accent}
:::
:::
...
- **Motivational Messages**: Encouragement tailored to your progress
...
I'm always working on new projects and improvements. Follow my [newsletter](https://newsletter.markgingrass.com) for updates on current work and upcoming releases.

[Subscribe to the Newsletter](https://newsletter.markgingrass.com){.btn .btn-primary} [View Source Code](https://github.com/mtgingrass){.btn .btn-secondary}
